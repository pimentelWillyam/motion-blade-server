...
class Api {
  constructor (readonly server: Express, readonly servantRouter: ServantRouter, readonly battleRouter: BattleRouter, readonly masterRouter: MasterRouter, readonly userRouter: UserRouter, readonly authRouter: AuthRouter) {
